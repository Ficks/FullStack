    ...
    <div class="container">
        ...
        <el-card class="box-card engineering"
          ...
          element-loading-background="rgba(0, 0, 0, 0.8)">
            <div slot="header" class="clearfix headers">
            <span>新闻中心</span>
                <el-button @click="onEngineeringDialog('添加新闻中心')" style="float: right; padding: 3px 0" type="text"><i class="el-icon-circle-plus"></i>添加</el-button>
            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="btns">
                            <el-tooltip class="item" effect="dark" content="修改" placement="top">
                                <i @click="onEngineeringDialog('修改新闻中心',o)" class="el-icon-edit-outline"></i>
                            </el-tooltip>
          ...
          element-loading-background="rgba(0, 0, 0, 0.8)">
              <el-form-item label="Banner图" prop="imageUrl">
                  <el-upload
                      ...
                      name="filename"
                      :action="$server+'upload/news/banner'"
          ...
          element-loading-background="rgba(0, 0, 0, 0.8)">
              <el-form-item label="缩略图" prop="imageUrl">
                  <el-upload
                      class="avatar-uploader"
                      name="filename"
                      :action="$server+'upload/news/list'"
                      :show-file-list="false"
